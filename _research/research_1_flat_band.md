---
title: "Band topology and quantum geometry in moiré flat bands"
collection: research
permalink: /research/research_1_flat_band
excerpt: 'Moiré systems provide the best platform to engineer isolated flat bands, enabling the studies on the interplay between band topology, quantum geometry, and correlation.'
---
...
<p style="text-align: justify;">
It is then natural to ask: what new physics might emerge when these two flat-band-generating mechanisms&mdash;moiré engineering and lattice geometry&mdash;are combined in a single system. Surprisingly, our study shows that the geometry-induced flat bands in their twisted homobilayer become isolated due to the moiré potential, where <i><strong>the numbers of isolated flat bands vary with twist angle</strong></i> <a href="#1">[1]</a>&mdash;a new physics that has never been found in popular twisted bilayer systems. Furthermore, in their twisted heterobilayers, <i><strong>the Berry curvature of such flat bands are also twist-angle tunable</strong></i> <a href="#2">[2]</a>. In addition to bipartite lattices, we proposed a newly discovered lattice structure—the <i>watermill lattice</i>—whose geometry hosts low-energy high-pseudospin fermions. In its twisted bilayer form, these states give rise to four isolated flat bands with enhanced quantum geometry <a href="#3">[3]</a>. More recently, in twisted bilayers of loop-current-ordered kagome lattices, we demonstrated that <i><strong>the quantum geometry of moiré flat bands can be fundamentally reconfigured and need not inherit that of the parent monolayer</strong></i> <a href="#4">[4]</a>, revealing a mechanism distinct from those established in systems such as TBG and TMD moiré materials. These results serve as compelling examples of how lattice geometry and moiré engineering can work in tandem to realize and control flat-band electronic structures.
</p>
...
## Related Publications
 ...
 - <a name="2">[2]</a> Xiaoting Zhou\*, __Yi-Chun Hung\*__, and Arun Bansil. Quantum Geometry of Moir´e Flat Bands: A Bipartite Lattice Paradigm Beyond Valley Physics. [_arXiv:2603.20852_](https://lengentyh.github.io/YiChunHung_Physics/publication/2026-03-23-t-D-on-G).

 - <a name="3">[3]</a> __Yi-Chun Hung\*__, Xiaoting Zhou\*, and Arun Bansil. Geometry-driven moiré in twisted bilayers of high pseudospin fermions. [_Phys. Rev. B 112_, L041403 (2025)](https://lengentyh.github.io/YiChunHung_Physics//publication/2025-07-14-watermill).

  - <a name="4">[4]</a> __Yi-Chun Hung__, Xiaoting Zhou, and Arun Bansil. Breakdown of Topological Inheritance and Twist-Induced Quantum Geometry Reconfiguration in Moiré Flat Bands. [_arXiv:2603.20849_](https://lengentyh.github.io/YiChunHung_Physics/publication/2026-03-23-tbLCK).